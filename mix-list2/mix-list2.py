...
# Create a list of common port numbers
ports = [22, 53, 80]
ports.insert(0, 443) # insert a port at the beginning of the list
ports.insert(2, 8080)
ports.insert(1, 143)
print(ports) # [443, 143, 22, 8080, 53, 80]

# Sort Items in Place
ports.sort()
print(ports) # [22, 53, 80, 143, 443, 8080]
